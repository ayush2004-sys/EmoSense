...
label_encoder_text = pickle.load(open("label_encoder.pkl", "rb"))
label_encoder_image = pickle.load(open("image_label_encoder.pkl", "rb"))
...
# -------------------- Footer --------------------
st.markdown("---")
st.markdown("Made with ❤️ by Your Name | Deep Learning | NLP | Streamlit")
